...
export default function LoginPage({isLogin}) {
    ...
    const formValue = useSelector((state) => state.loginDetails.loginInfo);
        ...
        <form onSubmit={handleSubmit}>
          <div className="bg-shaded_pink h-full">
            <div className="p-[25px] ">
              <div className="w-[60%] mx-auto">
                <h4 className="text-gray_blue font-henriette font-bold text-5xl lg:text-8xl leading-25 lg:leading-56 text-left">
                  Good news! We care for
                  <br />
                  pets in Winter Park.Let's
                  <br /> create your account.
                </h4>
              </div>

              <div className="mb-4 w-[60%] mt-[20px] mx-auto  ">
                <label
              ...
              <div className="flex mb-4 w-[60%] mt-[20px] mx-auto">
                <Field
                ...
                <label
                  ...
                  className="ml-2 block font-basic-sans text-3xl text-grayish_blue"
                >
            ...
            <div className="fixed bottom-[0px] w-2/3 py-[20px] bg-white_color grid grid-cols-2 ">
              <p className="text-gray_blue inline-block font-basic-sans">
